...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .tarjeta.bgc-slider.p-4.p-lg-5.mb-5(data-aos="fade-down")
      SlyderA.tarjeta.tarjeta--blanca.p-4.pt-5(tipo="b")
        .row.justify-content-center
          .col-lg-7.mb-4.mb-md-0
            h4.py-4 Tuberías de agua
            p Trasmiten plomo al agua de bebida. Actualmente está prohibido su uso, y todas las de este material deben ser cambiadas por PVC.
          .col-lg-4.mb-4.mb-md-0.col-8
            img(src='@/assets/curso/temas/t5/img03.png', alt='')
        
        .row.justify-content-center
          .col-lg-7.mb-4.mb-md-0
            h4.py-4 Contaminación ambiental
            p Procedente del uso de vehículos a motor los cuales emplean el tetraetilato de plomo como antidetonante en la gasolina.
          .col-lg-4.mb-4.mb-md-0.col-8
        ...
        .row.justify-content-center
          .col-lg-7.mb-4.mb-md-0
            h4.py-4 Envases alimentarios
            p Elaborados con material que contiene plomo como piezas cerámicas vidriada con sales de plomo o latas de hojalata donde se emplea soldadura blanca con una aleación de plomo y antimonio.
          .col-lg-4.mb-4.mb-md-0.col-8
    ...
    .subt(data-aos='fade-right')
      .row.align-items-center.mb-4
        ...
        .col-auto.ps-0
          h3.mb-0.pe-4.pe-lg-5 Mercurio (Hg)


    p El mercurio en estado natural no es tóxico, pero sí lo son las diversas formas que puede adoptar naturalmente o como consecuencia de procesos industriales o de transformación.
    p Es uno de los metales que mayor número de intoxicaciones, de origen alimentario,  ha ocasionado a lo largo de los años.  El mercurio se absorbe casi completamente por vía pulmonar.  Las sales de mercurio causan problemas de tipo cutáneo y en las mucosas.
    ...
    .cajon.color-acento-contenido.p-4.mb-4(data-aos='fade-right')
      ...
      p Las características químicas del metilo mercurio, y en especial su liposolubilidad, permiten un movimiento fácil a través de las membranas biológicas, esencialmente de la digestiva, hematoencefálica y placentaria, siendo sus principales órganos diana, el hígado, el sistema nervioso y el riñón.
    ...
    .subt(data-aos='fade-right')
      .row.align-items-center.mb-4
        .col-auto
          img(src='@/assets/curso/temas/t1/subt.png', alt='')
        .col-auto.ps-0
          h3.mb-0.pe-4.pe-lg-5 Arsénico (As)

    p El arsénico está considerablemente distribuido en la naturaleza y está presente en el medio ambiente y en los seres vivos. Se puede encontrar en distintas formas químicas y estados de oxidación, lo que determina su toxicidad. Las principales fuentes de exposición al arsénico son la laboral, la alimentaria y la medicamentosa.
    .cajon.color-acento-contenido.p-4.mb-4(data-aos='fade-right')
    ...
    .subt(data-aos='fade-right')
      .row.align-items-center.mb-4
        .col-auto
          img(src='@/assets/curso/temas/t1/subt.png', alt='')
        .col-auto.ps-0
          h3.mb-0.pe-4.pe-lg-5 Selenio (Se)
      ...
      .col-lg-7
        ...
        .tabla-a.color-acento-contenido
          table
            ...
            thead
              tr
                th Contaminante/tóxico
                th Nivel de seguridad toxicológico de referencia FAO/OMS
                th Posibles alimentos contaminados
            tbody
              tr.text-center
                td As (inorgánico)
